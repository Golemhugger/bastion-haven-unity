    ...
    public sealed class PersonActor : MonoBehaviour
    {
        ...
        void BuildMesh(int index)
        {
            ...
            if (Role == Role.Warden)
            {
                ...
                body = new Color(0.22f, 0.34f, 0.35f);
                dark = new Color(0.09f, 0.12f, 0.14f);
                accent = new Color(0.55f, 0.86f, 0.84f);
                scale = 1.10f;
                Speed = 3.2f;
                Job = Job.Patrol;
            }
            else if (Role == Role.Raider)
            {
                ...
                body = new Color(0.40f, 0.20f, 0.14f);
                dark = new Color(0.14f, 0.08f, 0.06f);
                accent = new Color(0.62f, 0.24f, 0.12f);
                scale = 0.97f;
                Speed = 2.8f;
                Job = Job.Idle;
            }
            ...
            _body = Part("Torso", new Vector3(0f, 1.08f, 0f), new Vector3(0.40f, 0.58f, 0.26f), body);
            Part("Head", new Vector3(0f, 1.54f, 0.03f), new Vector3(0.26f, 0.26f, 0.26f), body * 1.18f);

            if (Role == Role.Warden)
            {
                Part("Helm", new Vector3(0f, 1.66f, 0.02f), new Vector3(0.34f, 0.16f, 0.32f), dark);
                Part("Brim", new Vector3(0f, 1.60f, 0.14f), new Vector3(0.36f, 0.05f, 0.12f), dark);
                Part("Visor", new Vector3(0f, 1.57f, 0.16f), new Vector3(0.28f, 0.07f, 0.07f), accent, 2.0f);
                Part("Coat", new Vector3(0f, 0.78f, -0.08f), new Vector3(0.50f, 0.72f, 0.16f), dark);
                Part("CoatL", new Vector3(-0.24f, 0.82f, 0.02f), new Vector3(0.10f, 0.62f, 0.18f), dark);
                Part("CoatR", new Vector3(0.24f, 0.82f, 0.02f), new Vector3(0.10f, 0.62f, 0.18f), dark);
                Part("PauldronL", new Vector3(-0.28f, 1.28f, 0f), new Vector3(0.16f, 0.12f, 0.22f), dark);
                Part("PauldronR", new Vector3(0.28f, 1.28f, 0f), new Vector3(0.16f, 0.12f, 0.22f), dark);
                Part("Baton", new Vector3(0.34f, 0.92f, 0.20f), new Vector3(0.05f, 0.05f, 0.62f), new Color(0.10f, 0.10f, 0.11f));
            }
            else if (Role == Role.Raider)
            {
                Part("Chest", new Vector3(0f, 1.12f, 0.08f), new Vector3(0.36f, 0.28f, 0.12f), dark);
                Part("PadL", new Vector3(-0.26f, 1.26f, 0f), new Vector3(0.18f, 0.16f, 0.22f), accent);
                Part("PadR", new Vector3(0.26f, 1.26f, 0f), new Vector3(0.18f, 0.16f, 0.22f), dark);
                Part("Spike", new Vector3(-0.30f, 1.40f, 0f), new Vector3(0.07f, 0.32f, 0.07f), dark);
                Part("Spike2", new Vector3(0.22f, 1.36f, -0.04f), new Vector3(0.06f, 0.22f, 0.06f), dark);
            }
            else
            {
                Part("Hair", new Vector3(0f, 1.68f, 0f), new Vector3(0.24f, 0.10f, 0.26f), dark);
                Part("Scarf", new Vector3(0f, 1.34f, 0.04f), new Vector3(0.30f, 0.10f, 0.22f), accent);
                Part("Pack", new Vector3(0f, 1.02f, -0.20f), new Vector3(0.22f, 0.26f, 0.12f), dark);
            }

            _lLeg = Part("LLeg", new Vector3(-0.12f, 0.34f, 0f), new Vector3(0.13f, 0.50f, 0.13f), dark);
            _rLeg = Part("RLeg", new Vector3(0.12f, 0.34f, 0f), new Vector3(0.13f, 0.50f, 0.13f), dark);
            Part("LBoot", new Vector3(-0.12f, 0.08f, 0.04f), new Vector3(0.14f, 0.10f, 0.20f), dark * 0.7f);
            Part("RBoot", new Vector3(0.12f, 0.08f, 0.04f), new Vector3(0.14f, 0.10f, 0.20f), dark * 0.7f);
            ...
            sh.transform.localScale = new Vector3(0.55f, 0.02f, 0.55f);
            sh.GetComponent<Renderer>().sharedMaterial = BastionGfx.Mat(new Color(0.04f, 0.04f, 0.04f, 0.6f));
            Object.Destroy(sh.GetComponent<Collider>());
        }

        Transform Part(string n, Vector3 local, Vector3 scale, Color c, float emit = 0f)
        {
            ...
            go.GetComponent<Renderer>().sharedMaterial = BastionGfx.Mat(c, emit);
        ...
        public void Tick(float dt, Vector3 possessMove)
        {
            ...
            else
            {
                ...
                Phase += dt * 1.2f;
                if (_body) _body.localPosition = new Vector3(0f, 1.08f + Mathf.Sin(Phase) * 0.015f, 0f);
                if (_lLeg)
                {
